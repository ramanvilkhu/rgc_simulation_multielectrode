...
def expElectrodePitch(unit_curr_dir):
    ...
    Stim['electrodes'] = [[-1030,0,42],[-905,0,42]] #[[-1030,0,47],[-1000,0,47]]
    ...
    if scale_factor == np.nan:
        ...
        dir = '/Volumes/Lab/Users/vilkhu/data-backup/sim-data/elecPitch/triphasic/radial/elecPitch_125um/'
...
def main(): 
    ...
    pool = mp.Pool(36)
    print('Testing varied electrode pitches: 125um')
    ...
    result = list(tqdm.tqdm(pool.imap(expElectrodePitch, unit_vectors), total=len(unit_vectors)))
