...
def expMultisite(currents):
    ...
    Stim['electrodes'] = [[-1000,15,42],[-1030,15,42],[-1000,-15,42]]
    # Stim['electrodes'] = [[-1000,-15,42],[-1030,-15,42]]
    ...
    dir = '/Volumes/Lab/Users/vilkhu/data-backup/sim-data/selectivity_analysis_X/triplet_2/'
