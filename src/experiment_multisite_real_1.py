...
def expMultisite(currents):
    ...
    Stim['electrodes'] = [[-1060,0,62],[-1000,0,62]]
    ...
    dir = '/Volumes/Scratch/Users/vilkhu/sim-data/multisite/fixed/monophasic/fig3_y20_60um/005Dt/'
...
def main(): 
    ...
    pool = mp.Pool(10)
    print('Testing fixed monophasic bielec for fig3_y20_60um with 0.005 dt')
